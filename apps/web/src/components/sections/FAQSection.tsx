...
export function FAQSection() {
    ...
    // RETOUR UNIQUE ENVELOPPÉ DANS UN FRAGMENT <> </>
    return (
        <>
            {/* 1. Le composant SEO est placé ici, au tout début */}
            <SEO 
                title="Questions Fréquentes (FAQ) | Panda Holding RDC"
                description="Trouvez des réponses rapides sur les services, l'investissement et le fonctionnement de Panda Holding à Kinshasa."
                path="/faq" // Ajuste ce chemin si l'URL de ta page est différente (ex: "/a-propos")
                faqData={faqs.length > 0 ? faqs : undefined}
            />

            {/* 2. Ensuite, on gère les conditions d'affichage */}
            {loading ? (
                // État de chargement
                ...
                // 3. Rendu principal (quand les données sont là)
                <section className="py-24 lg:py-32 bg-gray-50/40 dark:bg-gray-900/40 relative overflow-hidden">
