                    ...
                    <div className="py-16 lg:py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
                        ...
                        <div className="space-y-6 animate-fadeInUp">
                            ...
                            <div className="flex items-center gap-3 pt-2">
                                {/* X (Twitter) */}
                                <a href="#" aria-label="X (Twitter)" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-accent hover:text-primary hover:border-accent transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-accent/20">
                                ...
                                {/* Facebook */}
                                <a href="#" aria-label="Facebook" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-accent hover:text-primary hover:border-accent transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-accent/20">
                                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                {/* Instagram */}
                                <a href="#" aria-label="Instagram" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-accent hover:text-primary hover:border-accent transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-accent/20">
                                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                {/* LinkedIn */}
                                <a href="#" aria-label="LinkedIn" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-accent hover:text-primary hover:border-accent transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-accent/20">
                                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
